...
lint-py:  ## lint python with ruff
	python -m ruff check cron_pydantic
	python -m ruff format --check cron_pydantic
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix cron_pydantic
	python -m ruff format cron_pydantic
...
test:  ## run python tests
	python -m pytest -v cron_pydantic/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v cron_pydantic/tests --cov=cron_pydantic --cov-report term-missing --cov-report xml
